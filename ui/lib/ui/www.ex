defmodule Ui.WWW do
  ...
  @session_config Raxx.Session.config(
                    ...
                    secret_key_base:
                      "GRwVqvnoYvfiBwK3j0c6lbc35mFEQVWY9AdY3tUc_sa1dKUYpOYTkn8FPubkq1Mm",
                    salt: "ZC7MRD"
                  )

  # This works even if the reference file is not available at start up,
  # i.e. it will be generated by npm scripts.
  @external_resource "lib/ui/www/public/main.css"
  @external_resource "lib/ui/www/public/main.js"
