defmodule Ui.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      {Ui.WWW, [cleartext_options]},
      {Ui.WWW, [secure_options]}
    ]
  ...
  defp certificate_path() do
    Application.app_dir(:ui, "priv/localhost/certificate.pem")
  end

  defp certificate_key_path() do
    Application.app_dir(:ui, "priv/localhost/certificate_key.pem")
  end
end
